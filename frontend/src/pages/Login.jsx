...
//       <form onSubmit={handleSubmit} className="p-6 bg-white shadow-xl rounded-xl space-y-4 w-80">
          ...
          <div>
            ...
            <div className="mt-1">
              <input
                ...
                value={form.email}
                onChange={(e) => setForm({ ...form, email: e.target.value })}
                className="w-full px-4 py-3 text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition"
